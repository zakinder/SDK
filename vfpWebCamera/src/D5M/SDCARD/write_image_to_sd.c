...
ycbcr_to_rgb(rgb_color_reg *rgb_color_ptr,u32 adrSof,int cb)
{
    ...
    ycbcr_color_ptr->y     = (((Xil_In16(adrSof + nAddre) & 0x00ff)) + (ycbcr_color_ptr->yS))/2;
    ...
    rgb_color_ptr->b = (unsigned)(ycbcr_color_ptr->y + 1.4075 * (ycbcr_color_ptr->v - 128));
    rgb_color_ptr->g = (unsigned)(ycbcr_color_ptr->y - 0.3455 * (ycbcr_color_ptr->u - 128) - (0.7169 * (ycbcr_color_ptr->v - 128)));
    rgb_color_ptr->r = (unsigned)(ycbcr_color_ptr->y + 1.7790 * (ycbcr_color_ptr->u - 128));
}
ycbcr_to_rgb_print(rgb_color_reg *rgb_color_ptr,u32 adrSof,int cb)
{
    ...
    rgb_color_ptr->g = (unsigned)(ycbcr_color_ptr->y - 0.3455 * (ycbcr_color_ptr->u - 128) - (0.7169 * (ycbcr_color_ptr->v - 128)));
    rgb_color_ptr->r = (unsigned)(ycbcr_color_ptr->y + 1.7790 * (ycbcr_color_ptr->u - 128));
    printf  ("i %i [y %i u %i v %i] [r %i g %i b %i] \n",cb,ycbcr_color_ptr->y,ycbcr_color_ptr->u,ycbcr_color_ptr->v,rgb_color_ptr->r,rgb_color_ptr->g,rgb_color_ptr->b);
}
